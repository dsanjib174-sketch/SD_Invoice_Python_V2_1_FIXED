...
Markdown tables now support basic smart selection. Use Expand Selection (Shift+Alt+RightArrow) to grow the selection from a cell to its row and then to the full table, and Shrink Selection (Shift+Alt+LeftArrow) to step back down.
